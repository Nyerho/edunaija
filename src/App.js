  ...
  return (
    <div className="auth-container">
      <div className="auth-header">
        <h1>Welcome to EduNaija</h1>
        <p>Access thousands of educational resources from Nigerian institutions</p>
        {error && <div className="error-message">{error}</div>}
      </div>
      ...
      <div className="forms-container">
        ...
        <div className="form-section login-section">
          ...
          <form onSubmit={handleLogin} className={`modern-auth-form ${(loggingIn || loading) ? 'form-loading' : ''}`}>
            <div className="input-group">
              <input
                ...
                required
                disabled={loggingIn || loading}
                className={`modern-input ${loggingIn || loading ? 'input-loading' : ''}`}
              />
            ...
            <button 
              type="submit" 
              disabled={loggingIn || loading}
              className={`modern-submit-btn login-btn ${loggingIn ? 'button-loading' : ''}`}
            >
              {loggingIn ? (
                <>
                  <div className="spinner"></div>
        ...
        <div className="form-section register-section">
          <div className="form-header">
            ...
            <p>New to EduNaija? Create your account to get started</p>
          </div>
          
          <form onSubmit={handleRegister} className={`modern-auth-form ${(registering || loading) ? 'form-loading' : ''}`}>
            <div className="name-row">
              <div className="input-group half-width">
                <input
                  ...
                  className={`modern-input ${registering || loading ? 'input-loading' : ''}`}
                />
            ...
            <button 
              type="submit" 
              disabled={registering || loading}
              className={`modern-submit-btn register-btn ${registering ? 'button-loading' : ''}`}
            >
              {registering ? (
                <>
                  <div className="spinner"></div>
